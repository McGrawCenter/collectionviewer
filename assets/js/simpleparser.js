                ...
                if ('canvases' in sequence) {
                    ...
                    for (const canvas of sequence.canvases) {
                        ...
                        if (canvas.images) {
                            ...
                            imageobj.service = canvas.images[0].resource.service;
                            imageobj.serviceurl = canvas.images[0].resource.service["@id"];
            ...
            for (const item of items) {
                ...
                if (item.items) {
                    ...
                    if (typeof service === Array) {
                        imageobj.service = service;
                        imageobj.serviceurl = service['@id'];
                    } else if (typeof service === 'object') {
                        if (service[0]) {
                            if (service[0]['id'] == null) {
                                imageobj.service = service[0];
                                imageobj.serviceurl = service[0]['@id'];
                            } else {
                                imageobj.service = service[0];
                                imageobj.serviceurl = service[0]['id'];
                            }
